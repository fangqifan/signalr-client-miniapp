...
var HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        this.httpClient = options.httpClient || new DefaultHttpClient_1.DefaultHttpClient();
    ...
    HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
            case ITransport_1.HttpTransportType.WebSockets:
                return new WebSocketTransport_1.WebSocketTransport(this.accessTokenFactory, this.logger, this.options.logMessageContent || false);
            default:
