(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["signalr-client-miniapp"] = factory();
	else
		root["signalr-client-miniapp"] = factory();
})(window, function() {
...
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
...
/* harmony import */ var _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(19);
...
/* harmony import */ var _Errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _HttpClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _MiniAppHttpClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
...
var DefaultHttpClient = /** @class */ (function (_super) {
    ...
    function DefaultHttpClient() {
        ...
        _this.httpClient = new _MiniAppHttpClient__WEBPACK_IMPORTED_MODULE_2__["MiniAppHttpClient"]();
        return _this;
    }
    /** @inheritDoc */
        ...
        return new Promise(function (resolve, reject) {
            ...
            requestObj.success = function (res) {
                ...
                if (res.statusCode >= 200 && res.statusCode < 300) {
                    resolve(new _HttpClient__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"](res.statusCode, res.statusCode.toString(), res.data));
                }
                else {
                    reject(new _Errors__WEBPACK_IMPORTED_MODULE_0__["HttpError"]("request failed.", res.statusCode));
                }
            };
            requestObj.fail = function () {
                reject(new _Errors__WEBPACK_IMPORTED_MODULE_0__["HttpError"]("request failed.", 0));
            };
...
/* harmony import */ var _HandshakeProtocol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var _IHubProtocol__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
/* harmony import */ var _TextMessageFormat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
/* harmony import */ var _HubConnection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
...
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var _ITransport__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
/* harmony import */ var _WebSocketTransport__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
...
var HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        this.logger = Object(_Utils__WEBPACK_IMPORTED_MODULE_3__["createLogger"])(options.logger);
        this.baseUrl = this.resolveUrl(url);
        options = options || {};
        options.logMessageContent = options.logMessageContent || false;
        this.httpClient = options.httpClient || new _DefaultHttpClient__WEBPACK_IMPORTED_MODULE_0__["DefaultHttpClient"]();
    ...
    HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
            case _ITransport__WEBPACK_IMPORTED_MODULE_2__["HttpTransportType"].WebSockets:
                return new _WebSocketTransport__WEBPACK_IMPORTED_MODULE_4__["WebSocketTransport"](this.accessTokenFactory, this.logger, this.options.logMessageContent || false);
            default:
                ...
                switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            webSocket.onMessage(function (data) {
                                _this.logger.log(_ILogger__WEBPACK_IMPORTED_MODULE_0__["LogLevel"].Trace, "(WebSockets transport) data received. " + Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["getDataDetail"])(data, _this.logMessageContent) + ".");
                                if (_this.onreceive) {
...
/* harmony import */ var _ITransport__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _Loggers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
/* harmony import */ var _TextMessageFormat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
//# sourceMappingURL=signalr-client-miniapp.js.map